...
describe('DSLRenderer', () => {
  ...
  it('typing in the search box filters the product_grid section', () => {
    const mixedStore = {
      ...fixtureStore,
      brand_token: {
        ...fixtureStore.brand_token!,
      ...
      products: [
        { ...fixtureStore.products[0], id: 'p1', name: 'Face Wash', description: 'gentle cleanser', category: 'care' },
        { ...fixtureStore.products[1], id: 'p2', name: 'Serum', description: 'vitamin c serum', category: 'care' },
        { ...fixtureStore.products[0], id: 'p3', name: 'Desk Lamp', description: 'warm light', category: 'home' },
      ],
      categories: ['care', 'home'],
    }
    render(<DSLRenderer store={mixedStore as any} slug="haree" />)
    ...
    fireEvent.change(screen.getByPlaceholderText('Search products…'), { target: { value: 'lamp' } })
  ...
  it('search and category filters combine (both must match)', () => {
    const mixedStore = {
      ...fixtureStore,
      brand_token: {
        ...fixtureStore.brand_token!,
      ...
      products: [
        { ...fixtureStore.products[0], id: 'p1', name: 'Face Wash', category: 'care' },
        { ...fixtureStore.products[0], id: 'p2', name: 'Desk Lamp', category: 'home' },
        { ...fixtureStore.products[0], id: 'p3', name: 'Table Lamp', category: 'home' },
      ],
      categories: ['care', 'home'],
    }
    render(<DSLRenderer store={mixedStore as any} slug="haree" />)
    ...
    fireEvent.click(screen.getByRole('button', { name: 'home' }))
    fireEvent.change(screen.getByPlaceholderText('Search products…'), { target: { value: 'desk' } })
